        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child:
                  Image.asset('images/ar_onboarding/show_loading_animator.png'),
            ),
            Container(
              padding: const EdgeInsets.symmetric(
                horizontal: 45.0,
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child:
                  Image.asset('images/ar_onboarding/show_option_controls.png'),
            ),
            Padding(
              padding: const EdgeInsets.symmetric(
                horizontal: 45.0,
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child:
                  Image.asset('images/ar_onboarding/show_plane_detection.png'),
            ),
            Container(
              padding: const EdgeInsets.symmetric(
                horizontal: 45.0,
